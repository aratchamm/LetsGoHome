...
{ 
	...
	if (!messageTexture.loadFromFile("img/tileset/message.png"))
		std::cout << "Error could not load glass" << std::endl;
	...
	if (!bubbleTexture.loadFromFile("img/tileset/bubble.png"))
		std::cout << "Error could not load glass" << std::endl;
	...
	const float gridSizeOutside = 32.f;
					...
					if (ev.type == sf::Event::TextEntered) { 
						if ((ev.text.unicode == '\b') && yourname.getSize() > 0) {
							...
							if (yourname.getSize() <= 0) { 
								yourname.erase(yourname.getSize(), 0);
								playerName.setString(yourname); 
								player_check = 0; 
							} 
						} 
							...
							if ((ev.text.unicode < 128) && (yourname.getSize() < 8) && (yourname.getSize() > 0) && (ev.text.unicode != '\b')) {
								soundEffect.setBuffer(typingSound);
								soundEffect.play();
								playerName.setFont(font); 
								playerName.setString(yourname); 
							...
							if ((ev.text.unicode == '\b') && (yourname.getSize() <= 1)) {
								yourname.clear();
								playerName.setString(yourname);
								player_check = 0;
							}
				...
				{ 
					if (ev.type == sf::Event::TextEntered) { 
						if ((ev.text.unicode == '\b') && yourPetname.getSize() > 0) {
							...
							playerPetName.setString(yourPetname); 
							if (yourPetname.getSize() <= 0) {
								yourPetname.erase(yourPetname.getSize(), 0);
								playerPetName.setString(yourPetname);
								player_Petcheck = 0;
							}
						} 
							...
							soundEffect.setBuffer(typingSound);
							soundEffect.play();
							if ((ev.text.unicode < 128) && (yourPetname.getSize() < 8) && (yourPetname.getSize() > 0) && (ev.text.unicode != '\b')) {
								soundEffect.setBuffer(typingSound);
								soundEffect.play();
								playerPetName.setFont(font);
								playerPetName.setString(yourPetname);
							...
							if ((ev.text.unicode == '\b') && (yourPetname.getSize() <= 1)) {
								yourPetname.clear();
								playerPetName.setString(yourPetname);
								player_Petcheck = 0;
							}
...
PLAY: 
		...
		FishCheck1.setPosition(2491.f, 1352.f); 
		FishCheck1.setFillColor(sf::Color::Transparent);
 
		sf::RectangleShape FishCheck2(sf::Vector2f(27.0f, 12.0f));
		FishCheck2.setPosition(2745.f, 1352.f); 
		FishCheck2.setFillColor(sf::Color::Transparent);
 
		sf::RectangleShape FishCheck3(sf::Vector2f(27.0f, 12.0f));
		FishCheck3.setPosition(2471.f, 449.f); 
		FishCheck3.setFillColor(sf::Color::Transparent);
 
		sf::RectangleShape FishCheck4(sf::Vector2f(27.0f, 42.0f));
		FishCheck4.setPosition(3023.f, 477.f); 
		FishCheck4.setFillColor(sf::Color::Transparent);
 
		sf::RectangleShape FishCheck5(sf::Vector2f(27.0f, 42.0f));
		FishCheck5.setPosition(3971.f, 477.f); 
		FishCheck5.setFillColor(sf::Color::Transparent);
 
		sf::RectangleShape FishCheck6(sf::Vector2f(27.0f, 62.0f));
		FishCheck6.setPosition(1061.f, 2826.f); 
		...
		sf::RectangleShape GlassCheck2(sf::Vector2f(81.0f, 97.0f));
		GlassCheck2.setPosition(1381.f, 2014.f); 
		...
		VaseCheck.setPosition(5832.f, 1334.f);
		VaseCheck.setFillColor(sf::Color::Transparent);
 
		sf::RectangleShape VaseCheck2(sf::Vector2f(27.0f, 72.0f));
		VaseCheck2.setPosition(5545.f, 1129.f);
		VaseCheck2.setFillColor(sf::Color::Transparent);
 
		sf::RectangleShape VaseCheck3(sf::Vector2f(27.0f, 92.0f));
		VaseCheck3.setPosition(5255.f, 1151.f);
		VaseCheck3.setFillColor(sf::Color::Transparent);
 
		sf::RectangleShape VaseCheck4(sf::Vector2f(27.0f, 92.0f));
		VaseCheck4.setPosition(5379.f, 1151.f);
		VaseCheck4.setFillColor(sf::Color::Transparent);
 
		sf::RectangleShape BookCheck2(sf::Vector2f(27.0f, 12.0f));
		BookCheck2.setPosition(3387.f, 578.f); 
		BookCheck2.setFillColor(sf::Color::Transparent);
 
		sf::RectangleShape BookCheck3(sf::Vector2f(27.0f, 12.0f));
		BookCheck3.setPosition(3122.f, 1209.f); 
		...
		sf::RectangleShape ClockCheck3(sf::Vector2f(27.0f, 52.0f));
		ClockCheck3.setPosition(3732.f, 789.f); 
		ClockCheck3.setFillColor(sf::Color::Transparent);
 
		sf::RectangleShape ClockCheck4(sf::Vector2f(92.0f, 92.0f));
		ClockCheck4.setPosition(5800.f, 1599.f);
		...
		KeyCheck6.setPosition(3406.f, 1708.f);
		...
		sf::RectangleShape messageCheck(sf::Vector2f(74.0f, 95.0f));
		messageCheck.setPosition(1150.f, 2986.f);
		messageCheck.setFillColor(sf::Color::Transparent);
		...
		std::vector<RectangleShape> wallsOutside;

		RectangleShape wallsOutsideShape;
		wallsOutsideShape.setFillColor(Color::Transparent);
		wallsOutsideShape.setSize(Vector2f(gridSizeOutside, gridSizeOutside));
		...
		std::vector<RectangleShape> boyShape;

		RectangleShape boyVector;
		boyVector.setFillColor(Color::Transparent);
		boyVector.setSize(Vector2f(gridSize, gridSize));

		// aunty check // 

		std::vector<RectangleShape> auntShape;

		RectangleShape auntVector;
		auntVector.setFillColor(Color::Transparent);
		auntVector.setSize(Vector2f(gridSize, gridSize));

		// manwithwife check // 

		std::vector<RectangleShape> manShape;

		RectangleShape manVector;
		manVector.setFillColor(Color::Transparent);
		manVector.setSize(Vector2f(gridSize, gridSize));
		...
		if (house_check == 0) { 
			...
			wallsOutsideShape.setPosition(gridSizeOutside * 35, gridSizeOutside * 88);
			...
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 44, gridSizeOutside * 100);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 117, gridSizeOutside * 69);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 35, gridSizeOutside * 79);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 37, gridSizeOutside * 79);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 39, gridSizeOutside * 79);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 40, gridSizeOutside * 80);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 40, gridSizeOutside * 88);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 40, gridSizeOutside * 90);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 40, gridSizeOutside * 92);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 40, gridSizeOutside * 76);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 40, gridSizeOutside * 78);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 40, gridSizeOutside * 74);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 37, gridSizeOutside * 74);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 34, gridSizeOutside * 74);
			wallsOutside.push_back(wallsOutsideShape);


		
			wallsOutsideShape.setPosition(gridSizeOutside * 40, gridSizeOutside * 87);
			wallsOutside.push_back(wallsOutsideShape);
			wall.setPosition(gridSize * 19, gridSize * 45); 
			walls.push_back(wall); 

			wallsOutsideShape.setPosition(gridSizeOutside * 37, gridSizeOutside * 87);
			wallsOutside.push_back(wallsOutsideShape);
			...
			wallsOutsideShape.setPosition(gridSizeOutside * 46, gridSizeOutside * 64);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 48, gridSizeOutside * 64);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 50, gridSizeOutside * 64);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 52, gridSizeOutside * 64);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 54, gridSizeOutside * 66);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 56, gridSizeOutside * 66);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 58, gridSizeOutside * 66);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 60, gridSizeOutside * 66);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 62, gridSizeOutside * 66);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 64, gridSizeOutside * 66);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 43, gridSizeOutside * 66);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 44, gridSizeOutside * 66);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 66, gridSizeOutside * 66);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 68, gridSizeOutside * 66);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 66, gridSizeOutside * 64);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 68, gridSizeOutside * 64);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 75, gridSizeOutside * 64);
			wallsOutside.push_back(wallsOutsideShape);
			...
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 56, gridSizeOutside * 88);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 60, gridSizeOutside * 88);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 62, gridSizeOutside * 88);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 56, gridSizeOutside * 82);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 60, gridSizeOutside * 82);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 62, gridSizeOutside * 82);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 58, gridSizeOutside * 82);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 67, gridSizeOutside * 86);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 66, gridSizeOutside * 88);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 68, gridSizeOutside * 86);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 71, gridSizeOutside * 86);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 72, gridSizeOutside * 86);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 74, gridSizeOutside * 86);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 75, gridSizeOutside * 86);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 77, gridSizeOutside * 86);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 67, gridSizeOutside * 85);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 68, gridSizeOutside * 85);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 71, gridSizeOutside * 85);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 72, gridSizeOutside * 85);
			wallsOutside.push_back(wallsOutsideShape);
			...
			wallsOutsideShape.setPosition(gridSizeOutside * 66, gridSizeOutside * 48);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 73, gridSizeOutside * 48);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 66, gridSizeOutside * 50);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 73, gridSizeOutside * 50);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 76, gridSizeOutside * 39);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 76, gridSizeOutside * 45);
			wallsOutside.push_back(wallsOutsideShape);
			...
			walls.push_back(wall); 
			wallsOutsideShape.setPosition(gridSizeOutside * 94, gridSizeOutside * 69);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 97, gridSizeOutside * 69);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 117, gridSizeOutside * 67);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 118, gridSizeOutside * 67);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 121, gridSizeOutside * 67);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 122, gridSizeOutside * 67);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 125, gridSizeOutside * 67);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 126, gridSizeOutside * 67);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 129, gridSizeOutside * 67);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 130, gridSizeOutside * 67);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 133, gridSizeOutside * 67);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 134, gridSizeOutside * 67);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 137, gridSizeOutside * 67);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 138, gridSizeOutside * 67);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 141, gridSizeOutside * 67);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 142, gridSizeOutside * 67);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 145, gridSizeOutside * 67);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 146, gridSizeOutside * 67);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 149, gridSizeOutside * 67);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 150, gridSizeOutside * 67);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 113, gridSizeOutside * 71);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 114, gridSizeOutside * 71);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 109, gridSizeOutside * 71);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 110, gridSizeOutside * 71);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 105, gridSizeOutside * 71);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 106, gridSizeOutside * 71);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 109, gridSizeOutside * 37);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 110, gridSizeOutside * 37);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 113, gridSizeOutside * 37);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 114, gridSizeOutside * 37);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 117, gridSizeOutside * 37);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 118, gridSizeOutside * 37);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 121, gridSizeOutside * 37);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 122, gridSizeOutside * 37);
			wallsOutside.push_back(wallsOutsideShape);
			...
			walls.push_back(wall); 
			wallsOutsideShape.setPosition(gridSizeOutside * 76, gridSizeOutside * 36);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 79, gridSizeOutside * 39);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 80, gridSizeOutside * 39);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 83, gridSizeOutside * 39);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 86, gridSizeOutside * 39);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 80, gridSizeOutside * 47);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 83, gridSizeOutside * 47);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 86, gridSizeOutside * 47);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 87, gridSizeOutside * 47);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 90, gridSizeOutside * 60);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 97, gridSizeOutside * 60);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 90, gridSizeOutside * 62);
			wallsOutside.push_back(wallsOutsideShape);
			wallsOutsideShape.setPosition(gridSizeOutside * 97, gridSizeOutside * 62);
			wallsOutside.push_back(wallsOutsideShape);
		...
		while (l != 2 && l != 1 && l != 0)l = rand();
		while (m != 2 && m != 1 && m != 0 && m!= 3)m = rand();
		...
		//  house 4
		//player.setPosition(3324.f, 978.f);
		//house 5
		//player.setPosition(3574.f, 2046.f);
		...
		while (window.isOpen()) { 
					...
					if (aevent.key.code == Keyboard::Escape) { 
						...
						if (player.getGlobalBounds().intersects(Home1.getGlobalBounds())) { 
							if (house_check == 0) { 
								...
								bubbleSprite.setPosition(-100000, -100000);
								...
								wallsOutsideShape.setPosition(gridSizeOutside * 27, gridSizeOutside * 94);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 29, gridSizeOutside * 94);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 27, gridSizeOutside * 96);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 29, gridSizeOutside * 96);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 30, gridSizeOutside * 89);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 33, gridSizeOutside * 89);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 35, gridSizeOutside * 89);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 38, gridSizeOutside * 88);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 40, gridSizeOutside * 89);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 36, gridSizeOutside * 92);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 39, gridSizeOutside * 92);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 50, gridSizeOutside * 86);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 50, gridSizeOutside * 88);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 44, gridSizeOutside * 86);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 44, gridSizeOutside * 88);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 24, gridSizeOutside * 100);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 26, gridSizeOutside * 100);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 28, gridSizeOutside * 101);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 31, gridSizeOutside * 101);
								...
								if(bubbleCheck == 0)bubbleSprite.setPosition(1134.f, 2926.f);
							...
							if (house_check == 0) { 
								...
								bubbleSprite.setPosition(-10000.f, -10000.f);
								...
								walls.push_back(wall); 
								wall.setPosition(gridSize * 22, gridSize * 28);
								walls.push_back(wall);
								wallsOutsideShape.setPosition(gridSizeOutside * 47, gridSizeOutside * 67);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 47, gridSizeOutside * 69);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 47, gridSizeOutside * 59);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 47, gridSizeOutside * 56);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 47, gridSizeOutside * 61);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 46, gridSizeOutside * 64);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 46, gridSizeOutside * 63);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 44, gridSizeOutside * 64);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 44, gridSizeOutside * 63);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 30, gridSizeOutside * 60);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 30, gridSizeOutside * 62);
								wallsOutside.push_back(wallsOutsideShape);
								
								wallsOutsideShape.setPosition(gridSizeOutside * 32, gridSizeOutside * 64);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 30, gridSizeOutside * 65);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 30, gridSizeOutside * 66);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 32, gridSizeOutside * 67);
								wallsOutside.push_back(wallsOutsideShape);
						...
						if (house_check == 0) { 
							...
							wall.setPosition(gridSize *38, gridSize * 16); 
							walls.push_back(wall); 
							wallsOutsideShape.setPosition(gridSizeOutside * 92, gridSizeOutside * 14);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 95, gridSizeOutside * 14);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 102, gridSizeOutside * 14);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 112, gridSizeOutside * 14);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 112, gridSizeOutside * 17);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 117, gridSizeOutside * 14);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 117, gridSizeOutside * 15);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 115, gridSizeOutside * 12);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 116, gridSizeOutside * 12);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 119, gridSizeOutside * 43);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 119, gridSizeOutside * 41);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 112, gridSizeOutside * 40);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 115, gridSizeOutside * 40);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 118, gridSizeOutside * 40);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 119, gridSizeOutside * 40);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 107, gridSizeOutside * 46);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 106, gridSizeOutside * 36);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 84, gridSizeOutside * 34);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 84, gridSizeOutside * 36);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 86, gridSizeOutside * 36);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 89, gridSizeOutside * 36);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 92, gridSizeOutside * 36);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 95, gridSizeOutside * 36);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 98, gridSizeOutside * 36);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 99, gridSizeOutside * 36);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 147, gridSizeOutside * 15);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 147, gridSizeOutside * 14);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 143, gridSizeOutside * 12);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 143, gridSizeOutside * 12);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 145, gridSizeOutside * 14);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 145, gridSizeOutside * 16);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 113, gridSizeOutside * 20);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 110, gridSizeOutside * 20);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 92, gridSizeOutside * 20);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 95, gridSizeOutside * 20);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 98, gridSizeOutside * 12);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 99, gridSizeOutside * 14);
							wallsOutside.push_back(wallsOutsideShape);
							
							wallsOutsideShape.setPosition(gridSizeOutside * 83, gridSizeOutside * 11);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 82, gridSizeOutside * 13);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 75, gridSizeOutside * 23);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 88, gridSizeOutside * 23);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 89, gridSizeOutside * 23);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 99, gridSizeOutside * 33);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 106, gridSizeOutside * 33);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 86, gridSizeOutside * 40);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 86, gridSizeOutside * 43);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 89, gridSizeOutside * 40);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 90, gridSizeOutside * 43);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 93, gridSizeOutside * 43);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 93, gridSizeOutside * 40);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 95, gridSizeOutside * 45);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 95, gridSizeOutside * 48);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 102, gridSizeOutside * 45);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 102, gridSizeOutside * 48);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 106, gridSizeOutside * 45);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 106, gridSizeOutside * 48);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 107, gridSizeOutside * 36);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 110, gridSizeOutside * 36);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 113, gridSizeOutside * 36);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 116, gridSizeOutside * 36);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 119, gridSizeOutside * 36);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 121, gridSizeOutside * 36);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 122, gridSizeOutside * 36);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 124, gridSizeOutside * 39);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 124, gridSizeOutside * 42);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 124, gridSizeOutside * 45);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 121, gridSizeOutside * 45);
							wallsOutside.push_back(wallsOutsideShape);
							wallsOutsideShape.setPosition(gridSizeOutside * 122, gridSizeOutside * 45);
							wallsOutside.push_back(wallsOutsideShape);
						} 
						else { 
						soundEffect.setBuffer(doorSound);
						...
						if (home5check == 1) { 
							if (house_check == 0) { 
								...
								wall.setPosition(gridSize * 47, gridSize * 25); 
								walls.push_back(wall); 
								wallsOutsideShape.setPosition(gridSizeOutside * 101, gridSizeOutside * 68);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 105, gridSizeOutside * 66);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 109, gridSizeOutside * 69);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 113, gridSizeOutside * 68);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 113, gridSizeOutside * 71);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 100, gridSizeOutside * 61);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 101, gridSizeOutside * 61);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 111, gridSizeOutside * 61);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 97, gridSizeOutside * 58);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 97, gridSizeOutside * 56);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 99, gridSizeOutside * 58);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 100, gridSizeOutside * 55);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 100, gridSizeOutside * 53);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 105, gridSizeOutside * 69);
								wallsOutside.push_back(wallsOutsideShape);
							} 
							else { 
							soundEffect.setBuffer(doorSound);
						...
						if (home6check == 1) { 
							if (house_check == 0) { 
								...
								manShape.clear();
								auntShape.clear();
								myhouse3.setPosition({ 4368.f, 606.f }); 
								Girl.setPosition(5176.f, 1360.f); 
								player.setPosition(5551.f, 1889.f); 
								stairsHome6.setPosition(5984.0f, 1359.0f); 
								row = 3; 
								
								Home6.setPosition(5551.f, 1889.f); 
								Grandma.setPosition(-10000.f, -10000.f); 
								Dog_mc.setPosition(-10000.f, -10000.f); 
								cat_mc.setPosition(-10000.f, -10000.f); 
								Boy.setPosition(-10000.f, -10000.f); 
								...
								walls.clear();
								wallsOutside.clear();
								wall.setPosition(gridSize * 79, gridSize * 20); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 81, gridSize * 21); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 79, gridSize * 30); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 79, gridSize * 29);
								walls.push_back(wall);
								wall.setPosition(gridSize * 81, gridSize * 30); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 82, gridSize * 31); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 84, gridSize * 31); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 86, gridSize * 31); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 88, gridSize * 31); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 90, gridSize * 31); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 92, gridSize * 30); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 93, gridSize * 30); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 95, gridSize * 30); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 96, gridSize * 28); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 78, gridSize * 22); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 96, gridSize * 26); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 95, gridSize * 25); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 93, gridSize * 25); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 91, gridSize * 25); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 95, gridSize * 24); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 93, gridSize * 24); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 91, gridSize * 24); 
								walls.push_back(wall); 
							
								wall.setPosition(gridSize * 94, gridSize * 20); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 93, gridSize * 18); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 91, gridSize * 18); 
								walls.push_back(wall); 
							
								wall.setPosition(gridSize * 88, gridSize * 17); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 87, gridSize * 17);
								walls.push_back(wall);
							
								wallsOutsideShape.setPosition(gridSizeOutside * 164, gridSizeOutside * 37);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 166, gridSizeOutside * 37);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 168, gridSizeOutside * 37);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 178, gridSizeOutside * 35);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 182, gridSizeOutside * 36);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 182, gridSizeOutside * 34);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 182, gridSizeOutside * 32);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 181, gridSizeOutside * 30);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 178, gridSizeOutside * 30);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 175, gridSizeOutside * 30);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 172, gridSizeOutside * 30);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 169, gridSizeOutside * 30);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 190, gridSizeOutside * 44);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 191, gridSizeOutside * 44);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 192, gridSizeOutside * 46);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 174, gridSizeOutside * 32);
								wallsOutside.push_back(wallsOutsideShape);
								wallsOutsideShape.setPosition(gridSizeOutside * 178, gridSizeOutside * 32);
								wallsOutside.push_back(wallsOutsideShape);

								wall.setPosition(gridSize * 86, gridSize * 14);
								walls.push_back(wall);
								wall.setPosition(gridSize * 84, gridSize * 15); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 83, gridSize * 15); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 81, gridSize * 16); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 81, gridSize * 18); 
								walls.push_back(wall); 
								
								wall.setPosition(gridSize * 78, gridSize * 23); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 78, gridSize * 25); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 78, gridSize * 27); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 78, gridSize * 29); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 91, gridSize * 19); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 92, gridSize * 19); 
								walls.push_back(wall); 
								wall.setPosition(gridSize * 95, gridSize * 29); 
								walls.push_back(wall);
								wall.setPosition(gridSize * 81, gridSize * 20);
								walls.push_back(wall);
							} 
							else { 
							soundEffect.setBuffer(doorSound);
						...
						if (player.getGlobalBounds().intersects(messageCheck.getGlobalBounds())) {

							if (Dialog_check == 0) {
								soundEffect.setBuffer(popSound);
								soundEffect.play();
								messageSprite.setPosition(player.getPosition().x - 610, player.getPosition().y - 450);
								Dialog_check = 1;
								pauseCheck = 1;
							}
							else if (Dialog_check == 1) {
								Dialog_check = 0;
								pauseCheck = 0;
								messageSprite.setPosition(-10000.f, -10000.f);
								bubbleSprite.setPosition(-10000.f, -10000.f);
								bubbleCheck = 1;
			...
			bubbleSprite.setTextureRect(sf::IntRect(97 * frameMC, 64 * 0, 97, 64));
			if (l == 0 && house_check == 0) {
				manShape.clear();
				manVector.setPosition(gridSize * 57, gridSize * 34);
				manShape.push_back(manVector);
				Boy.setTextureRect(sf::IntRect(32 * frameMC, 32 * 0, 32, 32));
			}
			else if (l == 1 && house_check == 0) {
				manShape.clear();
				manVector.setPosition(gridSize * 33, gridSize * 31);
				manShape.push_back(manVector);
				Boy.setTextureRect(sf::IntRect(32 * frameMC, 32 * 1, 32, 32));

			}
			else if (l == 2 && house_check == 0) {
				manShape.clear();
				manVector.setPosition(gridSize * 26, gridSize * 37);
				manShape.push_back(manVector);
			...
			if (m == 0 && house_check == 0) {
				...
				boyShape.push_back(boyVector);
				male.setTextureRect(sf::IntRect(32 * frameMC, 32 * 1, 32, 32));
			}
			else if (m == 1 && house_check == 0) {
				boyShape.clear();
				boyVector.setPosition(gridSize * 31, gridSize * 26);
				boyShape.push_back(boyVector);
				male.setTextureRect(sf::IntRect(32 * frameMC, 32 * 2, 32, 32));
			}
			else if (m == 2 && house_check == 0) {
				boyShape.clear();
				male.setTextureRect(sf::IntRect(32 * frameMC, 32 * 0, 32, 32));
			}
			else if (m == 3 && house_check == 0) {
				boyShape.clear();
				boyVector.setPosition(gridSize * 22, gridSize * 33);
				boyShape.push_back(boyVector);
				male.setTextureRect(sf::IntRect(32 * frameMC, 32 * 0, 32, 32));
			}
			if (n == 0 && house_check == 0) {
				auntShape.clear();
				auntVector.setPosition(gridSize * 34, gridSize * 19);
				auntShape.push_back(auntVector);
			}
			else if(n == 1 && house_check == 0) {
				auntShape.clear();
				auntVector.setPosition(gridSize * 58, gridSize * 15);
				auntShape.push_back(auntVector);
			}
